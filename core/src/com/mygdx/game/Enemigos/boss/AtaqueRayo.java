...
public class AtaqueRayo implements BossEstrategy {
    ...
    public AtaqueRayo(Texture warningTexture, TextureRegion damageTexture, Sound sound) {
...
//            batch.draw(warningTexture, bossX, bossY, 0, 0, warningTexture.getWidth(), warningTexture.getHeight(), 1, 1, rotation);
  ...
  //              batch.draw(damageTexture, bossX, bossY, 0, 0, damageTexture.getRegionWidth(), damageTexture.getRegionHeight(), 1, 1, rotation);
                sound.play();
            }
        }
    }
